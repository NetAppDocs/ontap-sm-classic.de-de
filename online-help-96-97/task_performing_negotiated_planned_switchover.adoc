...
+
** Wenn die Validierung erfolgreich ist, fahren Sie mit Schritt fort <<STEP_D638BF6093764719A0CF7421E478CF70,5>>.
...
+
*** Beheben Sie das Problem, das den Fehler verursacht, klicken Sie auf *Schließen* und starten Sie dann erneut bei Schritt <<STEP_2BC62367710D4E23B278E2B70B80EB27,1>>.
