...
.Schritte
. Geben Sie die URL ein `+https://IP-address-of-cluster-management-LIF+` Melden Sie sich in einem Webbrowser mit den Anmeldedaten des Cluster-Administrators an.
...
+
image::../media/aggregate_creation_nfs_esxi.gif[Erstellen eines Aggregats-Bildschirms in System Manager]
