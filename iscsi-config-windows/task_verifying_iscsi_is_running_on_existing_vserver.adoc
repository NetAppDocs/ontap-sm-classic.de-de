...
+
image::../media/vserver_service_iscsi_running_iscsi_windows.gif[Abbildung zeigt die Seite mit dem iSCSI-Protokoll mit einem grünen Symbol und den Text iSCSI-Service wird ausgeführt.]
